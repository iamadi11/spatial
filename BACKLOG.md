...
| 013 | Child count detection rule (flag oversized component children)      | rule    | 3        | active | Section 4.2.2, 7     | 005, 006            |
| 014 | Prop count detection rule (flag prop-heavy components)              | rule    | 3        | ready  | Section 4.2.2, 7     | 005, 006            |
