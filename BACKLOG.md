...
| 017 | Total node count detection rule (flag oversized component trees)    | rule    | 3        | active | Section 4.2.2, 7     | 005, 006            |
| 018 | Inline style count detection rule (flag excessive inline styles)    | rule    | 3        | ready  | Section 4.2.2, 7     | 005, 006            |
