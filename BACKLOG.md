...
| 027 | Large data prop detection rule (flag oversized prop payloads)      | rule    | 3        | active  | Section 4.2.2, 12   | 005, 006            |
...
| D08 | Issue severity filter on Analysis Playground page                  | feature | 3        | ready  | Section 16.6   | D05        |
